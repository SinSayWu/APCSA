    ...
    public static void main(String[] args) {
        ...
        while (play) {
            ...
            if (input.equals("right") || input.equals("r")) {
                ...
                System.out.println("Here are all of the commands you can use:\nright/left/down/up (r/l/d/u): Movement one space\njump/jumpleft/jumpup/jumpdown (jr/jl/jd/jd): Jump double space\npickup (p): pickup award\nreplay: Start from beginning\nquit (q): Quit\nhelp (?): See the help thing (here)");
            }
        }
